...
class TestMainFunctions(unittest.TestCase):
    ...
    def test_format_salary_returns_correctly_for_valid_input(self):
        ...
        assert format_salary(NET_SALARY_DEFAULT) == "5.000,00 CHF"
    ...
    def test_cli_calculates_net_salary_for_specific_canton(
        ...
        mock_calculator.return_value.calculate_net_salary.return_value = NET_SALARY_DEFAULT
